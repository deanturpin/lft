...
struct SymbolEvaluation {
  ...
  double daily_change_pct{};  // Daily change percentage (for market breadth)
  bool tradeable{};
...
std::chrono::system_clock::time_point session_start_time(std::chrono::system_clock::time_point);
